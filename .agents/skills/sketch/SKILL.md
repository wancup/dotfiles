...
論点は**ひとつずつ**提示し、その都度ユーザーの合意を取ってから次の論点へ進む。
...
1. **プロジェクト構成の把握**
   - ルートの主要ファイル（例: `package.json`, `pyproject.toml`, `Cargo.toml`, `go.mod`, `README.md`, `AGENTS.md`, `Makefile` など）
   - 主要ディレクトリの役割
...
探索では、必要最小限ではなく**方針判断に十分な情報**を集めること。
