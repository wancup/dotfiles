...
local nvim_clipboard_action = act.SplitPane({
	direction = "Down",
	size = { Cells = 5 },
	command = { args = { shell_path, "-c", "nvim_clipboard" } },
})

local char_select_action = act.CharSelect({
	copy_on_select = true,
...
local config = {
	...
	keys = {
		...
		{ key = "i", mods = "LEADER", action = nvim_clipboard_action },
		...
		{ key = "u", mods = "LEADER", action = char_select_action },
		...
		{ key = "Y", mods = "SUPER", action = act.QuickSelect },
		{ key = "c", mods = "SUPER", action = act.CopyTo("Clipboard") },
		{ key = "f", mods = "SUPER", action = act.Search("CurrentSelectionOrEmptyString") },
		{ key = "h", mods = "SUPER", action = act.ActivatePaneDirection("Left") },
		{ key = "i", mods = "SUPER", action = nvim_clipboard_action },
		{ key = "j", mods = "SUPER", action = act.ActivatePaneDirection("Down") },
		{ key = "k", mods = "SUPER", action = act.ActivatePaneDirection("Up") },
		{ key = "l", mods = "SUPER", action = act.ActivatePaneDirection("Right") },
		{ key = "n", mods = "SUPER", action = act.SpawnWindow },
		{ key = "p", mods = "SUPER", action = act.PaneSelect({ alphabet = "fjdksla;" }) },
		{ key = "q", mods = "SUPER", action = act.QuitApplication },
		{ key = "r", mods = "SUPER", action = act.ReloadConfiguration },
		{ key = "s", mods = "SUPER", action = act.SplitVertical({ domain = "CurrentPaneDomain" }) },
		{ key = "t", mods = "SUPER", action = act.SpawnTab("CurrentPaneDomain") },
		{ key = "u", mods = "SUPER", action = char_select_action },
		{ key = "v", mods = "SUPER", action = act.PasteFrom("Clipboard") },
		{ key = "w", mods = "SUPER", action = act.CloseCurrentPane({ confirm = true }) },
		{ key = "x", mods = "SUPER", action = act.PaneSelect({ alphabet = "fjdksla;", mode = "SwapWithActive" }) },
