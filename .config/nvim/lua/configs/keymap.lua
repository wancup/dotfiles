...
map("n", "<C-S-h>", "<C-w>h", { desc = "Goto left window" })
map("n", "<C-S-j>", "<C-w>j", { desc = "Goto bellow window" })
map("n", "<C-S-k>", "<C-w>k", { desc = "Goto above window" })
map("n", "<C-S-l>", "<C-w>l", { desc = "Goto right window" })
...
map("n", "<C-=>", window.previous_win, { desc = "Select Previous Window" })
